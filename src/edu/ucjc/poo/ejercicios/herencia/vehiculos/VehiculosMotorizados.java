...
public abstract class VehiculosMotorizados extends Vehiculo {
	...
	public void arrancar() {
		System.out.println("El vehículo con " + this.matricula + " estÃ¡ arrancando el motor con llave");
	}

	public void parar() {
		System.out.println("El vehículo con " + this.matricula + " estÃ¡ parando el motor");
	}
